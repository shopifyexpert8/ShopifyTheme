import { ConcreteAttributeNode, LiquidCST, LiquidHtmlCST, ConcreteLiquidLiteral } from '../parser/stage-1-cst';
...
export declare type LiquidAST = DocumentNode | LiquidNode | LiquidVariable | LiquidExpression | LiquidFilter | LiquidNamedArgument | AssignMarkup | CycleMarkup | ForMarkup | RenderMarkup | PaginateMarkup | RawMarkup | RenderVariableExpression | LiquidLogicalExpression | LiquidComparison | TextNode;
...
export declare type ParentNode = Extract<LiquidHtmlNode, HasChildren | HasAttributes | HasValue | HasName | HasCompoundName>;
...
export declare type HtmlNode = HtmlComment | HtmlElement | HtmlDanglingMarkerOpen | HtmlDanglingMarkerClose | HtmlVoidElement | HtmlSelfClosingElement | HtmlRawNode;
